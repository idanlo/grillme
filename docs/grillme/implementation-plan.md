...
- [x] Reuse T3Code's structured question cards and custom-answer path.
...
- [ ] Replace the remaining generic coding-workspace shell with a focused Grillme session shell.
