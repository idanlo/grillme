 ...
 *
 * ```ts
 * import { parseYaml } from "@grillme/shared/schemaYaml"
 *
 ...
 *
 * ```ts
 * import { stringifyYaml } from "@grillme/shared/schemaYaml"
 *
 ...
 * ```ts
 * import * as Schema from "effect/Schema"
 * import { fromYamlString } from "@grillme/shared/schemaYaml"
 *
