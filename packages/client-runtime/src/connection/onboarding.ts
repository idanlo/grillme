import type { DesktopSshEnvironmentTarget, EnvironmentId } from "@grillme/contracts";
import { resolveRemotePairingTarget } from "@grillme/shared/remote";
...
>()("@grillme/client-runtime/connection/onboarding/ConnectionOnboarding") {}
