...
>()("@grillme/client-runtime/platform/persistence/ConnectionTargetStore") {}
...
>()("@grillme/client-runtime/platform/persistence/ConnectionRegistrationStore") {}
...
>()("@grillme/client-runtime/platform/persistence/EnvironmentCacheStore") {}
...
}>("@grillme/client-runtime/platform/persistence/EnvironmentOwnedDataCleanup", {
  defaultValue: () => ({
    clear: () => Effect.void,
  }),
}) {}
