...
import { RelayManagedEndpoint } from "@grillme/contracts/relay";
...
export class RemoteDpopAccessToken extends Schema.Class<RemoteDpopAccessToken>(
  "@grillme/client-runtime/authorization/RemoteDpopAccessToken",
)({
...
>()("@grillme/client-runtime/authorization/tokenStore/RemoteDpopAccessTokenStore") {}
