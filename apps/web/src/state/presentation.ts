...
import type { EnvironmentPresentation } from "@grillme/client-runtime/connection";
import { createEnvironmentPresentationAtoms } from "@grillme/client-runtime/state/presentation";
