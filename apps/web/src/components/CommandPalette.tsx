...
import { scopeProjectRef, scopeThreadRef } from "@grillme/client-runtime/environment";
import { canCreateProjectInEnvironment } from "@grillme/client-runtime/operations/projects";
import { connectionStatusText } from "@grillme/client-runtime/connection";
import { threadSearchMatchKey } from "@grillme/client-runtime/state/thread-search";
import {
  canPreloadBrowsePath,
  createBrowseNavigationCoordinator,
  filterFilesystemBrowseEntries,
  getFilesystemBrowsePath,
} from "@grillme/client-runtime/state/filesystem";
import {
