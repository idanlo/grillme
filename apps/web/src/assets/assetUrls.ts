...
import { resolveAssetUrl } from "@grillme/client-runtime/state/assets";
import type { AssetResource, EnvironmentId } from "@grillme/contracts";
...
export { resolveAssetUrl } from "@grillme/client-runtime/state/assets";
