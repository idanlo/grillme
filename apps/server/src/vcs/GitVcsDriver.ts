...
>()("@grillme/server/vcs/GitVcsDriver") {}
  ...
  const checkpoints: VcsDriver.VcsCheckpointOps = {
    captureCheckpoint: Effect.fn("GitVcsDriver.checkpoints.captureCheckpoint")(function* (input) {
      ...
      const tempIndexPath = path.join(
        gitCommonDir,
        `grillme-checkpoint-index-${NodeCrypto.randomUUID()}`,
      );
      const commitEnv: NodeJS.ProcessEnv = {
        ...process.env,
        GIT_INDEX_FILE: tempIndexPath,
        GIT_AUTHOR_NAME: "Grillme",
        GIT_AUTHOR_EMAIL: "grillme@users.noreply.github.com",
        GIT_COMMITTER_NAME: "Grillme",
        GIT_COMMITTER_EMAIL: "grillme@users.noreply.github.com",
      };
      ...
      yield* Effect.gen(function* () {
        ...
        const message = `grillme checkpoint ref=${input.checkpointRef}`;
