...
import type { VcsDriverKind, VcsError, VcsRepositoryIdentity } from "@grillme/contracts";
import { VcsUnsupportedOperationError } from "@grillme/contracts";
...
>()("@grillme/server/vcs/VcsDriverRegistry") {}
