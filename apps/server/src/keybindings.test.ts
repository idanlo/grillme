import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "@grillme/contracts";
...
import { KeybindingsConfigError } from "@grillme/contracts";
    ...
    Layer.provideMerge(
      Layer.fresh(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "grillme-keybindings-test-",
        }),
      ),
    ),
  );
