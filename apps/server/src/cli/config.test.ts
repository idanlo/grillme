            ...
            ConfigProvider.layer(
              ConfigProvider.fromEnv({
                env: {
                  ...
                  T3CODE_MODE: "desktop",
                  GRILLME_PORT: "4001",
                  GRILLME_HOST: "0.0.0.0",
                  GRILLME_HOME: baseDir,
                  VITE_DEV_SERVER_URL: "http://127.0.0.1:5173",
                  T3CODE_DEV_ALLOWED_ORIGINS:
                    "https://host.example.ts.net, https://phone.example.ts.net ",
                  GRILLME_NO_BROWSER: "true",
                  GRILLME_AUTO_BOOTSTRAP_PROJECT_FROM_CWD: "false",
                  GRILLME_LOG_WS_EVENTS: "true",
                },
              }),
            ),
            NetService.layer,
            ...
            ConfigProvider.layer(
              ConfigProvider.fromEnv({
                env: {
                  ...
                  T3CODE_PORT: "4001",
                  T3CODE_HOST: "0.0.0.0",
                  GRILLME_HOME: join(NodeOS.tmpdir(), "ignored-base"),
                  VITE_DEV_SERVER_URL: "http://127.0.0.1:5173",
