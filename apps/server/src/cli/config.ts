...
import { parsePersistedServerObservabilitySettings } from "@grillme/shared/serverSettings";
import { DesktopBackendBootstrap, PortSchema } from "@grillme/contracts";
...
const EnvServerConfig = Config.all({
  ...
  otlpServiceName: Config.string("T3CODE_OTLP_SERVICE_NAME").pipe(Config.withDefault("grillme")),
