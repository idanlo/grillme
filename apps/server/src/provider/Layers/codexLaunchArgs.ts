import { tokenizeCliArgs } from "@grillme/shared/cliArgs";

export const GRILLME_CODEX_LAUNCH_ARGS_ENV = "GRILLME_CODEX_LAUNCH_ARGS";

export const resolveCodexLaunchArgs = (
  launchArgs?: string,
  environment: NodeJS.ProcessEnv = process.env,
) => environment[GRILLME_CODEX_LAUNCH_ARGS_ENV]?.trim() || launchArgs?.trim() || "";
