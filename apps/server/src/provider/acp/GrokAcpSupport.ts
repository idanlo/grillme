import { type GrokSettings, ProviderDriverKind } from "@grillme/contracts";
...
import { normalizeModelSlug } from "@grillme/shared/model";
...
const GRILLME_OAUTH_REFERRER = "grillme";
...
export function buildGrokAcpSpawnInput(
  ...
  return {
    ...
    env: {
      ...environment,
      [GROK_OAUTH2_REFERRER_ENV]: GRILLME_OAUTH_REFERRER,
    },
  };
}
