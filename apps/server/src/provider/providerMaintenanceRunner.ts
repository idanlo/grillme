...
>()("@grillme/server/provider/providerMaintenanceRunner") {}
            ...
            return yield* finish(
              makeUpdateState({
                ...
                message: couldNotVerify
                  ? "Update command completed, but Grillme could not verify the provider version."
                  : stillOutdated
                    ? "Update command completed, but Grillme still detects an outdated provider version."
                    : "Provider updated.",
                output: commandOutput(result),
              }),
            );
