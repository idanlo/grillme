...
import { SourceControlProviderError, type ChangeRequest } from "@grillme/contracts";
...
export const makeDiscovery = Effect.gen(function* () {
  ...
  return {
    ...
    label: "Bitbucket",
    installHint:
      "Set GRILLME_BITBUCKET_EMAIL and GRILLME_BITBUCKET_API_TOKEN on the server (use a Bitbucket API token with pull request and repository scopes).",
