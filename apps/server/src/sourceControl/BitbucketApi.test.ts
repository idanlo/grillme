...
import { GitCommandError } from "@grillme/contracts";
    ...
    Layer.provide(
      ConfigProvider.layer(
        ConfigProvider.fromEnv({
          env: {
            GRILLME_BITBUCKET_API_BASE_URL: "https://api.test.local/2.0",
            GRILLME_BITBUCKET_EMAIL: "user@example.com",
            GRILLME_BITBUCKET_API_TOKEN: "token",
          },
        }),
      ),
    ),
