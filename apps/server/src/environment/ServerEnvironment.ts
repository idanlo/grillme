import { EnvironmentId, type ExecutionEnvironmentDescriptor } from "@grillme/contracts";
import { HostProcessArchitecture, HostProcessPlatform } from "@grillme/shared/hostProcess";
...
>()("@grillme/server/environment/ServerEnvironment") {}
