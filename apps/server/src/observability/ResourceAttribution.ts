...
export interface ResourceAttributionSnapshot {
  readonly readAt: DateTime.Utc;
  readonly entries: ReadonlyArray<ResourceAttributionEntry>;
}
...
>()("@grillme/server/observability/ResourceAttribution") {}
...
export const make = Effect.fn("observability.resourceAttribution.make")(function* () {
